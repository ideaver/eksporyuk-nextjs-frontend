  ...
  return (
    <html>
      ...
      <body>
        ...
        <p>
          This privacy policy applies to the Rich Affiliate app (hereby referred
          to as "Application") for mobile devices that was created by Rich
          Affiliate (hereby referred to as "Service Provider") as a Free
        ...
        <p>
          ...
          phoneNumber, name, address. The information that the Service Provider
        ...
        <br />
        <p>This privacy policy is effective as of 2024-06-06</p>
        <br />
