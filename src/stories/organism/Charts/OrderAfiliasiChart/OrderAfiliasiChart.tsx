        ...
        <div className={`card ${className}`}>
            ...
            <div className='card-body d-flex flex-column'>
                ...
                <div className='d-flex justify-content-between pt-5'>
                    <div>
                        <h3 className={`text-center fw-bolder text-${chartColorPembayaran} mb-3 pe-3`}>--
                            <span className='fw-bold text-gray-500 fs-5 ps-2'>Menunggu Pembayaran</span>
                        </h3>
                ...
                <div className='d-flex justify-content-between'>
                    <div>
                        <h3 className={`text-center fw-bolder text-${chartColorProses} mb-3 pe-3`}>--
                            <span className='fw-bold text-gray-500 fs-5 ps-2'>Pesanan Diproses</span>
                        </h3>
                        <p className='text-start fs-6 '>
                ...
                <div className='d-flex justify-content-between'>
                    <div>
                        <h3 className={`text-center fw-bolder text-${chartColorPengiriman} mb-3 pe-3`}>--
                            <span className='fw-bold text-gray-500 fs-5 ps-2'>Proses Pengiriman</span>
                        </h3>
                        <p className='text-start fs-6 '>
...
const chartOptions = (
    ...
    const lightColor = getCSSVariableValue('--bs-' + chartColorPembayaran + '-light')
